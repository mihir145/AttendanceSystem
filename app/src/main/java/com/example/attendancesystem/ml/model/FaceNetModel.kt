package com.example.attendancesystem.ml.model
...
class FaceNetModel @Inject constructor(
    ...
    init {
        ...
        interpreter =
            Interpreter(
                FileUtil.loadMappedFile(context.applicationContext, model.assetsFilename),
                interpreterOptions
            )
    }
    ...
    class StandardizeOp : TensorOperator {
        ...
        override fun apply(p0: TensorBuffer?): TensorBuffer {
            ...
            var std = sqrt(pixels.mapIndexed { _, pi -> (pi - mean).pow(2) }
